        ...
        <div className="grid gap-8 md:grid-cols-2 p-6">
            <div className="card bg-base-200 shadow-xl rounded-xl overflow-hidden hover:scale-[1.015] transition-all duration-300">
                ...
                <div className="card-body p-4">
                    ...
                    <p className="opacity-80">
                        Macro perfecto, disciplina y las dinastías más fuertes del competitivo.
                    </p>
                    <div className="card-actions justify-end mt-3">
                        <button className="btn btn-neutral btn-sm">Ver más</button>
                    </div>
                </div>
            </div>
            ...
            <div className="card bg-base-200 shadow-xl rounded-xl overflow-hidden hover:scale-[1.015] transition-all duration-300">
                ...
                <div className="card-body p-4">
                    ...
                    <p className="opacity-80">
                        Caos, peleas constantes y un ritmo imposible de igualar.
                    </p>
                    <div className="card-actions justify-end mt-3">
                        <button className="btn btn-error btn-sm">Ver más</button>
                    </div>
                </div>
            </div>
            ...
            <div className="card bg-base-200 shadow-xl rounded-xl overflow-hidden hover:scale-[1.015] transition-all duration-300">
                ...
                <div className="card-body p-4">
                    ...
                    <p className="opacity-80">
                        Creatividad, drafts raros y remontadas que nadie ve venir.
                    </p>
                    <div className="card-actions justify-end mt-3">
                        <button className="btn btn-info btn-sm">Ver más</button>
                    </div>
                </div>
            </div>
            ...
            <div className="card bg-base-200 shadow-xl rounded-xl overflow-hidden hover:scale-[1.015] transition-all duration-300">
                ...
                <div className="card-body p-4">
                    ...
                    <p className="opacity-80">
                        Memes, copium y alguna sorpresa internacional de vez en cuando.
                    </p>
                    <div className="card-actions justify-end mt-3">
                        <button className="btn btn-neutral btn-sm">Ver más</button>
                    </div>
